package com.hoangdv.admob.admob

import android.app.Activity
import androidx.annotation.NonNull
import com.hoangdv.admob.admob.util.UserConsentRequester
...
class AdmobPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        channel = MethodChannel(flutterPluginBinding.binaryMessenger, "admob")
